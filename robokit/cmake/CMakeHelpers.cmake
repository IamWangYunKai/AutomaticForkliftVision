...
macro(add_source_folder folder_name)
    ...
    source_group("include\\${folder_name}" FILES ${H_FILES_IN_FOLDER_${folder_name}})
    source_group("src\\${folder_name}" FILES ${CPP_FILES_IN_FOLDER_${folder_name}})
...
macro(include_dirs PARENT SUFFIX)
    file(GLOB SDIRS "${PARENT}/*")
    foreach (SUBDIR ${SDIRS})
        IF(IS_DIRECTORY ${SUBDIR})
            include_directories("${SUBDIR}/${SUFFIX}")
            message("Includes Dir: " ${SUBDIR}/${SUFFIX})
        ENDIF()
    endforeach ()
endmacro()
