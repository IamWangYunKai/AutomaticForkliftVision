...
main ()
{
  ...
  pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color(origin_cloud, 0, 255, 0);
  viewer->addPointCloud<pcl::PointXYZ>(origin_cloud, single_color, "sample cloud");
  //viewer->addPointCloud(origin_cloud);
