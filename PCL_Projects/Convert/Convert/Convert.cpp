...
int main()
{
	cout << "Input your stl file name:" << endl;
	std::string obj_file;
	cin >> obj_file;
	cout << "Input your pcd file name:" << endl;
	std::string pcd_file;
	cin >> pcd_file;

	pcl::PolygonMesh mesh;
	//pcl::io::loadPolygonFileOBJ(obj_file, mesh);
	pcl::io::loadPolygonFileSTL(obj_file, mesh);
	pcl::PointCloud<pcl::PointXYZ>::Ptr cloud(new pcl::PointCloud<pcl::PointXYZ>);
	pcl::fromPCLPointCloud2(mesh.cloud, *cloud);
	pcl::io::savePCDFileASCII(pcd_file, *cloud);
	cout << "File convert successfilly !" << endl;
	system("pause");
	return 0;
}
*/
...
const int default_number_samples = 10000;
const float default_leaf_size = 0.005f;
